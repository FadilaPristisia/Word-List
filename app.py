...
def error():
    ...
    if suggestions:
        return render_template('laman-error.html', msg=msg, suggestions=suggestions.split(", "), keyword=keyword)
    else:
        return render_template('laman-error.html', msg=msg, keyword=keyword)



@app.route('/detail/<keyword>',methods=['GET','POST'])
def detail(keyword):
    api_key = "af0979fc-8130-4c18-bb2c-723afcae3d2d"
...
# @app.route('/practic',methods=['GET','POST'])
# def home():
